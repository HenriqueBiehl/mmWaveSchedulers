...
def crossover_multiselection(population, elitism_rate, tournament_size, gene_size, population_size, dna, selection_type, crossover_type, child_selection):
...
def crossover(population, elitism_rate, gene_size, population_size):
    fitness_values = fitness_batch(population)
